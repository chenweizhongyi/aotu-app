        ...
        for i in range(self.yaml.caselen()):
            if self.yaml.get_operate_type(i) == 'click':
                ...
                if self.yaml.get_findtype(i) == 'text':
                    self.baseoperate.get_accessibility_id(self.yaml.get_elementinfo(i)).click()
                    logger.info('成功获取：%s'%self.yaml.get_elementinfo(i))
                ...
                self.driver.implicitly_wait(3)
                if self.yaml.get_findtype(i) == 'text':
                    self.baseoperate.get_accessibility_id(self.yaml.get_elementinfo(i)).send_keys(self.yaml.get_send_content(i))
                elif self.yaml.get_findtype(i) == 'id':
